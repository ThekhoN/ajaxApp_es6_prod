...
import userAgentCheck_android442 from './userAgentCheck_android442';
/*
      ...
      myFastdomX99.mutate(function() {
        ...
        .then(function () {
          ...
          if(pogIdList_arr.length < 1){
            ...
            let Url_secondReq = getUrl_secondRequest(firstUrl, pogIdList_arr);

            if(userAgentCheck_android442()){
            ...
            axios.get(Url_secondReq)
              .then(function (response) {
                //console.log(response.data);
                let data = response.data;
                errorLog4.innerHTML = `typeof secondReq.data: ${typeof data} <br/>
